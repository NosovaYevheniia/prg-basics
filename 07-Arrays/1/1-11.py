# The weather station measures temperature once a day. The measurement results for each day 
# in March are stored in an array. Write a program that analyzes the temperature based on the
